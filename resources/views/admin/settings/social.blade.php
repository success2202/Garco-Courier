                                        ...
                                        <div class="text-muted d-flex justify-content-between">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="facebook"  value="{{ $setting->facebook }}" class="form-control @error('facebook') is-invalid @enderror" id="exampleInputEmail1"
                                ...
                                <li class="list-group-item">
                                    <div class="flex-grow-1 min-width-0">
                                        ...
                                        <div class="text-muted d-flex justify-content-between">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="twitter"  value="{{ $setting->twitter }}" class="form-control @error('twitter') is-invalid @enderror" id="exampleInputEmail1"
                                ...
                                <li class="list-group-item">
                                    <div class="flex-grow-1 min-width-0">
                                        ...
                                        <div class="text-muted d-flex justify-content-between">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="instagram"  value="{{ $setting->instagram }}" class="form-control @error('instagram') is-invalid @enderror" id="exampleInputEmail1"
                                ...
                                <li class="list-group-item">
                                    <div class="flex-grow-1 min-width-0">
                                        ...
                                        <div class="text-muted d-flex justify-content-between">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" name="linkedIn"  value="{{ $setting->linkedIn}}" class="form-control @error('instagram') is-invalid @enderror" id="exampleInputEmail1"
