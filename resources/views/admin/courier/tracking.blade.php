                        ...
                        <div class="col-md-6">
                                <div class="form-group"> 
                                    <select name="courier_info_id" class="form-control @error('courier_info_id') is-invalid @enderror" required> 
                                        <option value="{{$shipment->id}}"> {{$shipment->product}} {{$shipment->sender_name}}  {{$shipment->receiver_name}}</option>
                                    </select>
                                    <small id="emailHelp" class="form-text text-muted">Select shipment
                                    </small>
